...
<div class="relative overflow-x-auto w-[35%] sm:rounded-lg mx-auto mt-9">
    ...
    <div>
        <a href="{{route('categories_create')}}" class="inline-block focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Добавить</a>
    </div>
</div>
...
{{--                    @endif--}}
                ...
                <td class="px-6 py-4 flex">
                    <a href="{{route('categories_edit', $category->id)}}" class="p-1" title="Редактировать">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" >
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m14.304 4.844 2.852 2.852M7 7H4a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-4.5m2.409-9.91a2.017 2.017 0 0 1 0 2.853l-6.844 6.844L8 14l.713-3.565 6.844-6.844a2.015 2.015 0 0 1 2.852 0Z"/>
                        </svg>
                    </a>
                    <form action="{{route('categories_destroy', $category->id)}}" method="post">
                        @csrf
                        @method('delete')
